<div class="container content">
    <div class="row main-article text-justify">
        <div class="col-md-12">
            ...
            <section>
                ...
                <article>
                    ...
                    manajemen.
                    Akuntansi memiliki banyak manfaat dalam dunia bisnis diantaranya menyediakan
                    informasi ekonomis suatu perusahaan untuk pengambilan keputusan investasi dan kredit,
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1>Persamaan Akuntansi</h1>
                </div>
                <div class="col-md-6">
                    <article>
                        <p>Persamaan dasar akuntansi adalah rumus dasar tentang akuntansi yang secara matematis dapat
                            dirumuskan sebagai berikut :</p>
                        <ul class="list-unstyled mll">
                            <li>H = Harta, yaitu semua milik (Kekayaan) dari suatu perusahaan.</li>
                            <li>U = Utang, yaitu kewajiban perusahaan terhadap pihak lain.</li>
                            <li>M = Modal, yaitu hak pemilik perusahaan.</li>
                        </ul>

                        <p>Rumus lain :</p>
                        <ul class="list-unstyled mll">
                            <li>B = Biaya, pengorbanan untuk memperoleh penghasilan.</li>
                            <li>P = Pendapatan, adalah bertambahnya aktiva perusahaan.</li>
                        </ul>
                        <p>Harta bersaldo normal di debet (bertambah) dan jika di kredit berkurang, sedangkan pendapatan
                            bersaldo normal di kredit (bertambah) dan jika di debet berkurang, biaya mengurangi modal
                            sedangkan pendapatan menambah modal.</p>
                    </article>
                </div>
                <div class="col-md-6 text-center">
                    <img src="<?=$this->framework->url->get_base_url()?>/assets/images/layout/accounting-image.png" class="img-responsive center-block">
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <article>
                        ...
                        <ol class="mll">
                            ...
                            <li>Piutang wesel (notes receivable)</li>
                            <li>Perlengkapan (supplies)</li>
                            <li>Beban dibayar dimuka (prepaid expenses)</li>
                            <li>Tanah (land)</li>
                            <li>Gedung (building)</li>
                            <li>Peralatan (equipment)</li>
                            <li>Mesin (machine)</li>
                        </ol>
                    </article>
                </div>
                <div class="col-md-4">
                    <article>
                        ...
                        <ol class="mll">
                            ...
                            <li>Utang gaji (salary payable)</li>
                            <li>Utang bunga (interest payable)</li>
                            <li>Utang sewa (rent payable)</li>
                            <li>Utang pajak (tax payable)</li>
                            <li>Utang Obligasi (bonds payable)</li>
                            <li>Utang sewa guna usaha (lease obligation)</li>
                            <li>Dll.</li>
                        </ol>
                    </article>
                </div>
                ...
                <div class="col-md-4">
                    <article>
                        ...
                        <ol class="mll">
                            ...
                            <li>Expenses</li>
                            <li>Investment</li>
                            <li>Prive/ drawing/ withdrawal</li>
                        </ol>
                    </article>
                </div>
            </div>
            ...
            <section>
                ...
                <article>
                    ...
                    <p>
                        ...
                        Kuitansi bewujud lembaran-lembaran yang terdiri dari dua bagian dan biasanya telah terjilid seperti buku, bagian yang kanan atau bagian yang akan disobek adalah bagian untuk orang yang membanyar sedangkan bagian yang kiri untuk penerima uang pembayaran.
                    </p>

                    <h3>Nota Kontan (Notes)</h3>
                    <p>
                        Nota kontan atau sering disebut "Nota" adalah bukti pembelian atau penjualan barang yang dilakukan secara tunai. Nota merupakan bukti transaksi yang sering dijumpai selain kuitansi, misalnya saja ketika kalian pergi ke jasa foto kopi untuk memfoto kopi beberapa dokumen setelah itu kalian meminta nota ke jasa foto kopi tersebut maka kalian akan diberikan sebuah nota yang menerangkan harga foto kopi dokumen kalian.
                    </p>

                    <h3>Faktur (Invoices)</h3>
                    <p>
                        Faktur merupakan bukti pembelian atau penjualan barang yang dilakukan secara kredit. Faktur dibuat rangkap tiga, yang pertama untuk bagian gudang, yang kedua bagian keuangan (yang digunakan untuk proses penagihan) dan yang ketiga untuk pembeli sebagai bukti bahwa dia mempunyai hutang.
                    </p>

                    <h3>Nota Debit</h3>
                    <p>
                        Nota debit merupakan bukti transaksi pengembalian barang yang dibuat oleh pembeli, barang dikembalikan karena tidak sesuai pesanan atau barang cacat.
                    </p>

                    <h3>Nota Kredit</h3>
                    <p>
                        Nota kredit merupakan bukti transaksi pengembalian barang yang dibuat oleh penjual, barang dikembalikan karena tidak sesuai pesanan atau barang cacat.
                    </p>
                </article>
            </section>
            ...
            <section>
                ...
                <article>
                    ...
                    <p>
                        Laporan laba/rugi adalah laporan yang mencatat unsur - unsur penghasilan dan beban perusahaan yang sampai akhirnya menghasilkan suatu laba atau rugi bersih.
                        Inti dari laporan rugi / laba adalah mencatat seluruh penghasilan (pemasukan) dan beban (pengeluaran) perusahaan dalam kurun waktu tertentu. unsur laba/rugi biasanya terdiri dari penghasilan, total semua penghasilan, bebean, jumlah semua beban dan hasil akhir.
                        Laba/rugi = total semua penghasilan - jumlah semua beban.
                    </p>

                    <h3>Laporan Perubahan Modal</h3>
                    <p>
                        Laporan perubahan modal adalah bagian dari laporan keuangan yang mencatat informasi tentang penyebab bertambah atau berkurangnya modal dalam kurun waktu tertentu.
                        Unsur - unsur laporan perubahan modal biasanya terdiri dari modal awal, laba/rugi bersih, prive, penambahan modal, dan hasil akhir. Perubahan modal akhir = modal awal + (laba bersih - prive).
                    </p>

                    <h3>Laporan Neraca</h3>
                    <p>
                        Neraca adalah bagian dari laporan keuangan yang mencatat informasi tentang asset, kewajiban pembayaran pada pihak yang terkait dalam proses operasional perusahaan, dan modal pada saat tertentu.
                        Unsur - unsur neraca biasanya terdiri dari aktiva (baik aktiva lancar, jangka panjang, tetap, maupun aktiva tak berwujud), kewajiban (baik kewajiban jangka panjang maupun jangka pendek), dan modal.
                    </p>

                    <h3>Laporan Arus Kas</h3>
                    <p>
                        Laporan arus kas adalah bagian dari laporan keuangan yang mencatat informasi tentang aliran kas masuk dan keluar suatu perusahaan dalam kurun waktu tertentu. Jadi laporan arus kas erat hubungannya dengan pemasukkan yang berarti penghasilan dan pengeluaran yang berarti beban. Unsur - unsur laporan arus kas biasanya terdiri dari aktiva operasi, aktiva operasi, aktiva investasi dan aktiva pembiayaan.
                    </p>

                    <h3>Catatan atas Laporan Keuangan</h3>
                    <p>
                        Catatan atas laporan keuangan adalah catatan tambahan yang ditulis setelah laporan keuangan selesai disusun. Tujuan dari catatan atas laporan keuangan ini adalah menjelaskan segala bentuk keterangan yang tidak bisa dijelaskan didalam laporan keuangan,
                    </p>
                </article>
            ...
            <div class="row">
                <div class="col-md-4">
                    <article>
                        <ol class="mll">
                            ...
                            <li>Penyusutan (Depreciation)</li>
                            <li>Akun Aset (Asset Accounts)</li>
                            <li>Akun Beban (Expense Accounts)</li>
                            <li>Akun Ekuitas (Equity Accounts)</li>
                            <li>Akun Kewajiban (Liability Accounts)</li>
                            <li>Akun Modal Pemilik (Owner's Equity Account)</li>
                            <li>Akun Pendapatan (Revenue Accounts)</li>
                            <li>Akun Riil/ Akun Neraca (Real Accounts)</li>
                        </ol>
                    </article>
                </div>
                <div class="col-md-4">
                    <article>
                        <ol class="mll">
                            <li>Akuntansi Biaya (Cost Accounting)</li>
                            <li>Aset (Assets)</li>
                            <li>Beban (Expenses)</li>
                            <li>Beban Gaji (Salary Expense)</li>
                            <li>Beban Iklan (Advertising Expense)</li>
                            <li>Beban Listrik, Telepon, Air/ Beban</li>
                            <li>Beban Operasi (Operasional Expenses)</li>
                ...
                <div class="col-md-4">
                    <article>
                        <ol class="mll">
                            <li>Jurnal/ Buku Harian (Journal)</li>
                            <li>Kas (Cash)</li>
                            <li>Kewajiban (Liabilities)</li>
                            <li>Laba (Profit)</li>
                            <li>Laba setelah Pajak (Net Income after Taxes)</li>
                            <li>Neraca Saldo (Trial Balance)</li>
                            <li>Laporan Keuangan (Financial Statement)</li>
