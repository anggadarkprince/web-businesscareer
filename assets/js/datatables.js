	...
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).addClass('pagination').append(
				'<ul>'+
					'<li class="previous disabled"><a href="#"><i class="glyphicon glyphicon-chevron-left"></i></a></li>'+
...
$(document).ready(function() {
    ...
    $('table th .checkbox').on('click', function () {
        if($(this).hasClass('checked')){
            $(this).closest('table').find('tbody tr .checkbox').removeClass('checked');
            $(this).closest('table').find('tbody tr').removeClass('success');
        }
        else{
            $(this).closest('table').find('tbody tr .checkbox').addClass('checked');
