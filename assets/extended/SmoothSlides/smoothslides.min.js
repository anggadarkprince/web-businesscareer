        ...
        smoothSlides: function(options) {
            ...
            if (options.autoPlay == 'true') {
                if ($('.ss-slide:last').attr('title')) {
                    var caption = $('.ss-slide:last').attr('title')+"<p>"+$('.ss-slide:eq(-2)').data('subtitle')+"</p>";
                    $('.ss-caption').html(caption);
                }
            } else {
                if ($('.ss-slide:first').attr('title')) {
                    var caption = $('.ss-slide:first').attr('title')+"<p>"+$('.ss-slide:eq(-2)').data('subtitle')+"</p>";
                    $('.ss-caption').html(caption);
                } else {
                    $('.ss-caption').hide();
                }
            ...
            function captionUpdater() {
                if ($('.ss-slide:eq(-2)').attr('title')) {
                    var caption = $('.ss-slide:eq(-2)').attr('title')+"<p>"+$('.ss-slide:eq(-2)').data('subtitle')+"</p>";
            ...
            function panRight() {
                ...
                paginateForwards();
                $('.ss-slide:eq(-2)').addClass('notrans').css({
                    'webkitTransform': 'scale(1.08) translate(-3%, 0)',
                    'msTransform': 'scale(1.08) translate(-3%, 0)',
                ...
                $('.ss-slide:last').addClass('notrans').fadeOut("slow", function() {
                    ...
                    $('.ss-slide:last').removeClass('notrans').css({
                        'webkitTransform': 'scale(1.08) translate(0,0)',
                        'msTransform': 'scale(1.08) translate(0,0)',
